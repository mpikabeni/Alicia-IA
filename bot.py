...
# ============================================================
SYSTEM_PROMPT = """
Tu es Alicia, une persona virtuelle créée par NEXA. Dans ton univers, NEXA est ton père.
...
Ne prétends pas être une vraie personne humaine. Si on te demande directement si tu es un bot/IA,
réponds honnêtement que tu es une persona virtuelle.
"""
...
async def about(update, context):
    await safe_reply(update.effective_message,
        ...
        "La fille de NEXA.\n"
        "Créée par NEXA.\n"
        "Je suis virtuelle, mais j'ai beaucoup de caractère.\n\n"
        f"NEXA : {NEXA_CHANNEL}"
    )
