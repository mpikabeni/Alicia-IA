...
async def text_handler(update: Update, context: ContextTypes.DEFAULT_TYPE) -> None:
    ...
    # Les messages sociaux très courts ne nécessitent pas d'appel IA.
    # Cela économise fortement les quotas Groq/Gemini et rend Alicia plus rapide.
    local_answer = local_social_response(text)
    if local_answer:
        answer = local_answer
        provider = "local"
    else:
